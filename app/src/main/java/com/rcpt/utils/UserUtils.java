...
public class UserUtils {
    ...
    private static final String SHARED_NAME = "rcptShared";
    private static final String SHARE_PASSWORD = "share_password";
    private static final String FILE_NAME = "rcpt.txt";
    //密码加密的文件
    private static final String PASSWORD_NAME = "rcpt_password.efs";
